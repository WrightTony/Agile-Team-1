        ...
        <div class="card-body">
          ...
          <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="filter" role="tabpanel" aria-labelledby="filter-tab">
              ...
              <script>
              function checkboxClickFilter(Location currentLocation) {
                // disable address and zip search boxes if they are not already disabled
                ...
                //clear any input that is already in the box
                document.getElementById('addressInputFilter').value = currentLocation;
            ...
            int counter;
                    ...
                    if(procedureSearch[0]!=""){
                        ...
                        <div class ="container p-3 my-3 border">
                          ...
                          <p><%= result.getString("providerStreetAddress") %></p>
                          <p><%= result.getString("HRRDescription")%></p>
                          <p><%= Database.calculateDistance(currentLocation, targetLocation); %></p>
                          <p>Average medical care payments: $<%= result.getDouble("Average_Medicare_Payments")%></p>
                            </div>
