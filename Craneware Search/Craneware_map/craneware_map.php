...
// Select all the rows in the map table
...
while ($row = @mysqli_fetch_assoc($result)){
  ...
  echo 'street="' . parseToXML($row['Provider_Street_Address']) . '" ';
  echo 'city="' . parseToXML($row['Provider_City']) . '" ';
  echo 'state="' . parseToXML($row['Provider_State']) . '" ';
  echo 'postcode="' . parseToXML($row['Provider_Zip_Code']) . '" ';
